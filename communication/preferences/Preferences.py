...
class Preferences:
    ...
    def is_item_among_top_10_percent(self, item, item_list):
        ...
        if item in sorted_item_list[:int(10*len(item_list)/100)+1]:
            return True
        return False
...
if __name__ == '__main__':
    ...
    print('Is Diesel Engine in the top 10: {}'.format(agent_pref.is_item_among_top_10_percent(diesel_engine,
